...
$pdf->SetAuthor(utf8_encode('Felipe Zúñiga'));
$pdf->SetTitle('Fixture Copa del Mundo Brasil 2014 - CS&OR');
// $pdf->SetSubject('TCPDF Tutorial');
$pdf->SetKeywords('Polla Mundialera, Brasil 2014, CS&OR');
...
$pdf->Output('Polla_Brasil_2014_CSOR.pdf', 'I');
