...
-- Fixture with lock window (enabled): 5 min before kickoff (from vw_fixture)
...
-- Aggregated match prediction distribution for fixtures closed by the 5-min lock
...
-- ===== migrations/20260628000002_prediction_lock_5_min.sql =====
