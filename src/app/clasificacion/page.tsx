...
export default async function ClasificacionPage() {
  ...
  const { data: rankingsRaw, error } = await supabase
    ...
    .select(
      "id_pool, owner_id, display_name, username, is_paid_group_phase, is_paid_knockout, match_points, exact_hits, goal_diff_hits, winner_hits, side_bet_points, tournament_points, total_points, rank_position",
    )
    .order("rank_position");
